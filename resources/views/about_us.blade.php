...
<div class="">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <img class="img-responsive" src="{{asset('/images/img-01.jpg')}}">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                ...
                <p class="section-container-spacer">    
                    Auctor augue mauris augue neque. Posuere lorem ipsum dolor sit amet consectetur adipiscing. Porta non pulvinar neque laoreet. Viverra ipsum nunc aliquet bibendum. Iaculis urna id volutpat lacus. Turpis egestas pretium aenean pharetra magna ac. Id cursus metus aliquam eleifend mi. Odio tempor
                ...
                <div class="row section-container-spacer">
                    <div class="col-md-6">
                        <img class="img-responsive" src="{{asset('/images/img-03.jpg')}}">
                    </div>
                    <div class="col-md-6">
                        <img class="img-responsive" src="{{asset('/images/img-02.jpg')}}">
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                ...
                <small class="signature pull-right">Sori Dembélé</small>
            </div>
        </div>
    </div>
</div>
